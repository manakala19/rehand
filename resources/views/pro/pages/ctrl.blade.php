            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="card-header">
                        <h2 class="ms-3 py-3 text-dark">Control Admin</h2>
                    </div>
                            ...
                            <tbody>
                                <tr>
                                    @foreach ($data as $i)
                                        ...
                                        <td>
                                            <a class="btn btn-info btn-md" href="/profile">Detail</a>
                                            <a class="btn btn-warning btn-md"
                                                href="{{ url('/admin/' . $i->nik . '/edit') }}">Edit</a>
                                            @if ($i->nik != '1')
                                                <form onsubmit="return confirm('Rill Delete?')" class="d-inline"
                                                    action="/admin/{{ $i->nik }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                            ...
                                            @if ($i->nik != '1')
                                                <a class="btn btn-secondary btn-md"
                                                    href="{{ url('/respas/' . $i->nik . '/edit') }}">Change
                                                    Password
                                                </a>
                                            @endif
                                        </td>
